...
public class SingleSharing implements Initializable {
    ...
    private void writeDB(){
        ...
        try {
            ...
            if (result.next()) {
                bed = result.getInt("single_sharing");
            }
        ...
        String query = "INSERT INTO single_sharing "
                +"VALUES(?,?,?,?,?,?)";
        ...
        try {
            ...
            preparedStatement2.setInt(6, 150000);
        ...
        String update = "UPDATE count SET single_sharing=? WHERE idcount=1";
        ...
        try{
            ...
            statementHistory.setString(5, "Single");
