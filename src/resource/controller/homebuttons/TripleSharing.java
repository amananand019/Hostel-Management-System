...
public class TripleSharing implements Initializable {
    ...
    private void writeDB(){
        ...
        try {
            ...
            if (result.next()) {
                bed = result.getInt("triple_sharing");
            }

            if (bed == 30) {
                Alert alert = new Alert(Alert.AlertType.INFORMATION);
                alert.setTitle("Full");
                alert.setHeaderText("Triple Sharing is not available.");
                alert.show();
                closeStage();
                return;
            }
        ...
        String query = "INSERT INTO triple_sharing "
                +"VALUES(?,?,?,?,?,?)";
        ...
        String update = "UPDATE count SET triple_sharing=? WHERE idcount=1";
        ...
        try{
            ...
            statementHistory.setString(5, "Triple");
